    ...
    return (
        <div className="space-y-8 text-white">
            <header className="flex flex-col gap-4 rounded-3xl border border-white/10 bg-gradient-to-r from-white/10 via-white/5 to-white/5 p-6 shadow-2xl shadow-indigo-900/40 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <p className="text-sm font-semibold uppercase tracking-widest text-white/60">Provider Hub</p>
                    <h1 className="text-3xl font-bold text-white">Your Services</h1>
                    <p className="mt-1 text-sm text-white/70">Showcase your offerings and keep track of what clients can book.</p>
                </div>
                <Link
            ...
            {services.length === 0 ? (
                <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/20 bg-white/5 px-6 py-12 text-center shadow-2xl shadow-indigo-900/30 backdrop-blur">
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                    {services.map((service) => (
                        <Link
                            ...
                            className="group relative flex flex-col rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-indigo-900/30 transition hover:-translate-y-1 hover:border-indigo-400/40 hover:shadow-2xl hover:shadow-indigo-900/40"
                        >
